...
from .shareholder import DayDetailsShareHolder, DayDetailsShareHolderDataRow
...
class DayDetails:
    ...
    def get_orderbook_data(self) -> list[DayDetailsOrderBookDataRow]:
        ...
        return [
            DayDetailsOrderBookDataRow(
                time=data["time"],
                buy_rows=[
                    DayDetailsOrderBookRow(
                        time=row["time"],
                        count=row["count"],
                        price=row["price"],
                        volume=row["volume"],
